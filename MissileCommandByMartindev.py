...
gr.color("yellow")
gr.goto(0, -360)
gr.shapesize(stretch_wid=10, stretch_len=80)
...
# Initial Game setup
game = MissileCommand(800, 600, "black", "Missile Command by Martindev", 5)
game.score = 0
...
for i in range(30):
    if i <10:
        ...
        x = 350
    player_missiles_storage.append(PlayerMissile("circle", "blue", x, -225))
